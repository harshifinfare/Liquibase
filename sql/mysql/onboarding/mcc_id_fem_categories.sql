...
-- changeset ningz:onboarding-mcc_id_fem_categories
create table onboarding.onboarding.mcc_id_fem_categories
(
    mcc                       int          not null,
...
create index fk_mcc_id_fem_categories_fem_mcc_groups1_idx
    on onboarding.mcc_id_fem_categories (fem_group_id);


-- rollback DROP TABLE onboarding.mcc_id_fem_categories