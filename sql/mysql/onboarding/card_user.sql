...
-- changeset ningz:onboarding-card_user
create table onboarding.onboarding.card_user
(
    ...
    signup_request_id         int          default 1                    null,
...
create index fk_marqeta_user_token
    on onboarding.card_user (marqeta_user_token);


-- rollback DROP TABLE onboarding.card_user